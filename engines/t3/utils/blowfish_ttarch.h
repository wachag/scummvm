...
void Blowfish_encipher7(blf_ctx *, unsigned long *xl, unsigned long *xr);
void Blowfish_decipher7(blf_ctx *, unsigned long *xl, unsigned long *xr);
short InitializeBlowfish7(blf_ctx *, unsigned char key[], int keybytes);
